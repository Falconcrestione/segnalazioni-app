  ...
  return (
    <div style={{ padding: "40px", fontFamily: "Arial, sans-serif" }}>
      ...
      <table border={1} cellPadding={8} cellSpacing={0} width="100%">
        ...
        <tbody>
          <tr>
            <td>D'aquila Srls  –  via dell'Agricoltura, 61,87012, Castrovillari</td>
            <td><a href="tel:0981489665">0964 347935</a></td>
          </tr>
